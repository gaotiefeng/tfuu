...
public class JsonArray implements Iterable<Object> {
     ...
     * the RFC-7493, so this method assumes there is a String value and it
     ...
     * String using the {@link Enum#name} method and the value added as a
     * String.
     *
     * @param value
     *            the value
    ...
    /**
     * Does the JSON array contain the specified value? This method will scan
     * the entire array until it finds a value or reaches the end.
     *
     * @param value
     *            the value
     ...
     *         Map, a {@link JsonObject} is built from this Map and returned. It
     *         the value is a List, a {@link JsonArray} is built form this List
     *         and returned.
     */
